...
const page = async () => {
    ...
    return (
        <>
            ...
            <PortfolioHeadingSection title="My Blogs" description="Browse through the project cards for a quick overview, and click on any project to see detailed insights and creative solutions." />
