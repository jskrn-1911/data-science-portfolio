                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                        <div className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className='text-black text-xl'>Monica115@gmail.com</p>
                            </div>
                            <div className="space-y-4">
                        ...
                        <div className="">
                            ...
                            <form action="" className='space-y-6'>
                                <div className="border-b border-black flex items-start gap-4">
                                    ...
                                    <input type="text" name="name" id="name" placeholder='John Smith' className='text-xl text-black h-7 focus:bg-light-pink w-full outline-none'/>
                                </div>
                                <div className="border-b border-black flex items-start gap-4">
                                    <label htmlFor="email" className='text-xl text-black bg-light-sky-blue'>Email</label>
                                    <input type="text" name="email" id="email" placeholder='janesmith33@mail.com' className='text-xl text-black h-7 focus:bg-light-pink w-full outline-none'/>
                                </div>
                                <div className="border-b border-black flex items-start gap-4">
                                    <label htmlFor="msg" className='text-xl text-black bg-light-sky-blue whitespace-nowrap'>Your Message</label>
                                    <textarea name="msg" id="msg" placeholder="Hi, Monica..." rows={3} className='text-xl text-black focus:bg-light-pink w-full outline-none'/>
                                </div>
                                <Button variant='primary2' label="Submit" className='w-full'/>
                            </form>
                        </div>
                    </div>
                </div>
