      ...
      <header className='pt-4 outer-spacing fixed top-0 w-full z-50'>
        <div className={`bg-white main-container py-4 px-4 xl:ps-8 xl:pe-4 border border-black ${isOpen ? 'rounded-[20px] xl:rounded-[60px]' : 'rounded-[60px]'} flex items-stretch xl:items-center justify-between flex-col xl:flex-row transition-all duration-300 overflow-hidden`}>
          <div className="flex items-center justify-between">
            <p className="text-xl leading-7 bg-light-pink font-semibold w-fit p-1">Monica</p>
          ...
          <div className="overflow-hidden h-0 xl:!h-auto transition-all duration-300" ref={menuLinksContainerRef}>
            <div className={`flex items-center flex-col xl:flex-row gap-8 pb-5 pt-8 xl:pt-0 xl:pb-0 `} ref={menuLinksRef}>
              <div className="flex items-center flex-col xl:flex-row gap-6 xl:gap-8">
                <Link href="#" className="text-xl relative p-1 z-2 group">Portfolio
                <div className="absolute top-0 left-0 w-[0%] group-hover:w-full bg-[#9ddcff] h-full z-[-1] transition-all duration-300"></div>
                </Link>
                <Link href="#" className="text-xl relative p-1 z-2 group">FAQ
                 <div className="absolute top-0 left-0 w-[0%] group-hover:w-full bg-[#9ddcff] h-full z-[-1] transition-all duration-300"></div>
                 </Link>
                <Link href="#" className="text-xl relative p-1 z-2 group">Resume
                 <div className="absolute top-0 left-0 w-[0%] group-hover:w-full bg-[#9ddcff] h-full z-[-1] transition-all duration-300"></div>
                 </Link>
              </div>
              <div className="flex items-center  gap-4">
                <Link href="#" className='hover:rotate-[16deg] transition-all duration-300'><FaXTwitter className="w-6 h-6" /></Link>
                <Link href="#" className='hover:rotate-[16deg] transition-all duration-300'><FaDribbble className="w-6 h-6" /></Link>
                <Link href="#" className='hover:rotate-[16deg] transition-all duration-300'><FaInstagram className="w-6 h-6" /></Link>
              </div>
